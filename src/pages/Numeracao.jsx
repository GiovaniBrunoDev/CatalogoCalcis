    ...
    return (
        <div className="relative min-h-screen bg-gray-50 text-gray-800 flex flex-col">
            ...
            <div className="relative w-full aspect-[18/10] overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-start justify-center px-6 sm:px-12 text-white z-10 animate-fadeIn">
                    <h2 className="text-2xl sm:text-4xl font-bold mb-4">BEM-VINDO À CALCIS</h2>
                    <p className="text-sm sm:text-lg font-medium mb-4">
                        <span className="font-bold">ESTILO, CONFORTO E QUALIDADE</span>
                        <br />
                        PARA TODOS OS MOMENTOS.
                    </p>
                    <button className="bg-gray-900 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded-full text-sm sm:text-base">
          ...
          .animate-fadeIn {
            animation: fadeIn 2s ease-out forwards; /* mais demorado */
          }
        `}</style>
            </div>

            {/* Card central (numeração) */}
            <motion.div
                initial={{ y: 50, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.6, ease: "easeOut" }}
                className="
    w-full max-w-xl bg-white rounded-1xl shadow-xl p-8 mx-auto
    -mt-[-15] sm:-mt-50 md:-mt-24  /* empurra pra cima em diferentes telas */
    relative z-20 border border-gray-200
  "
            >
